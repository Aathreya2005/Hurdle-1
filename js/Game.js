class Game {
    ...
    async start() {
        ...
        runner1.scale = 1;
        runner1.setCollider("rectangle", 0, 0,40,100)
      //  runner1.debug = true;
        runner1.velocityY = 2;
        ...
        runner2.setCollider("rectangle", 0, 0,40,100);
     //   runner2.debug = true;
            ...
            for (var plr in allPlayers) {
                ...
                if (index === player.index) {
                    ...
                    if (keyIsDown(UP_ARROW) && player.index !== null) {
                     ...
                     runners[index-1].velocityY = player.velocityY + 0.8
...
function spawnObstacles() {
    ...
    if (frameCount % 90 === 0) {
        i = i + 1000
        var obstacle = createSprite(7500, 425);
...
function spawnObstacles1() {
    if (frameCount % 90 === 0) {
        ...
        var obstacle = createSprite(6500, 685);
